...
enum Command {ADD,UP,DOWN, LEFT, RIGHT, START,INFO,STOP,QUIT,INVALID};
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            switch (cmd){
                ...
                case DOWN:field.moveDown(choosePlayer(scanner));break;
                case LEFT:field.moveLeft(choosePlayer(scanner));break;
                case RIGHT:field.moveRight(choosePlayer(scanner));break;
